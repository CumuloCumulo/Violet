...
- [x] 3.4 为 RoomService、ChatService、PresenceService 编写单元测试
...
- [x] 4.7 编写集成测试：四人聊天完整流程（创建关系→破冰→加入→发消息→验证接收）
...
- [x] 6.6 编写军师模式集成测试：验证三种模式下消息可见性隔离
...
- [x] 7.4 编写生命周期集成测试：验证完整状态流转下的聊天室行为
